...
def title_detail(request, pk):
    ...
    return render(request, 'title_detail.html', {
        'content': content, 'user_score': user_score,
        'similar': similar, 'cast_list': cast_list,
    })
...
def user_profile(request, username):
    ...
    for r in ratings:
        ratings_with_content.append({'rating': r, 'content': content_map.get(r.title)})
    return render(request, 'user_profile.html', {
        'profile_user': profile_user, 'ratings': ratings_with_content,
        'ratings_count': ratings.count(), 'top_genres': top_genres,
        'avg_score': avg_score, 'taste_match': taste_match,
...
def users_list(request):
    ...
    return render(request, 'users_list.html', {'users_data': users_data, 'total': len(users_data)})
